...
#define PRINTER_NAME "Cappy Tarantula"  // Change this to whatever you wish, or leave it as it is.
...
#define STRING_CONFIG_H_AUTHOR "(Cappy Tevo Config V1)" // Who made the changes.
